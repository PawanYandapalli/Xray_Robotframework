...
Locate And Interact With Search Input
    [Documentation]  Ensure the search input field is interactable and enter a query.
...
Select Edit Personal Information From Search Results
    ...
    Wait Until Element Is Visible      ${EDIT_PERSONAL_INFO}   timeout=20s
